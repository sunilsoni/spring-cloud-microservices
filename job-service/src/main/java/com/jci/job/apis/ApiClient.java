...
public interface ApiClient {
	...
	public ResponseEntity<PoDetailsRes> getPoDetails(@RequestParam("apikey") String apikey,@RequestParam("erp") String erp);
	...
	public String getPoDetailsRes(@RequestBody SuccessReq poList,@RequestParam("apikey") String apikey,@RequestParam("erp") String erp);
	...
	public String getItemsRes(@RequestBody SuccessReq itemList,@RequestParam("apikey") String apikey,@RequestParam("erp") String erp);
	...
	public ResponseEntity<SuppDetailsRes> getSupp(@RequestParam("apikey") String apikey,@RequestParam("erp") String erp);
	...
	public String getSuppRes(@RequestBody SuccessReq supplierList,@RequestParam("apikey") String apikey,@RequestParam("erp") String erp);
	...
	public ResponseEntity<GrDetailsRes> getGrDetails(@RequestParam("apikey") String apikey,@RequestParam("erp") String erp);
	...
	public String getGrDetailsRes(@RequestBody SuccessReq poList,@RequestParam("apikey") String apikey,@RequestParam("erp") String erp);
