...
* [Rohit Ghatol](https://www.linkedin.com/in/jci)
...
* [eureka-server](eureka-server/README.md) - Eureka server
...
* Run the individual images as below; note that the auth-server and api-gateway images fail because of Spring Boot 1.2.x bug.
    ...
    * Eureka Server
        * docker run -d --name registry-server -p 8761:8761 anilallewar/eureka-server
...
* https://github.com/jci/spring-boot-microservices/tree/master/user-webservice
* https://github.com/jci/spring-boot-microservices/tree/master/task-webservice
