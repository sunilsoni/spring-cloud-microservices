package com.jci.gateway.config;
...
/*	public void match(RequestMatchers matchers) {
		System.out.println("### Starting Ending OAuthConfiguration.match ####"+matchers.anyRequest());
		matchers.anyRequest();
	}*/
	...
	System.out.println("### Starting OAuthConfiguration.configure ####"+http);
        http
        	.authorizeRequests()
        ...
        System.out.println("### Ending OAuthConfiguration.configure ####"+http);
    } 
		...
		//	.authorizeRequests()
			...
			///.and()
			//	.addFilterAfter(createCSRFHeaderFilter(), SessionManagementFilter.class);
	...
	private Filter createCSRFHeaderFilter() {
		System.out.println("### Starting Ending OAuthConfiguration.createCSRFHeaderFilter ####");
