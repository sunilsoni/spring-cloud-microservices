...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
		System.out.println("### Starting  ResourceServerConfiguration.configure ####"+http);
         http
         .requestMatchers().antMatchers("/me")    
         .and()
         .authorizeRequests()
         .antMatchers("/me").access("#oauth2.hasScope('read')");
         System.out.println("### Ending  ResourceServerConfiguration.configure ####");
    }
    ...
    public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
    	System.out.println("### Starting  Ending ResourceServerConfiguration.configure ####"+resources);
